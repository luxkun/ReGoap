...
namespace ReGoap.Godot
{
    ...
    public partial class ReGoapPlannerManager<T, W> : global::Godot.Node
    {
        ...
        private readonly List<ReGoapPlanWork<T, W>> doneWorks = new List<ReGoapPlanWork<T, W>>();
        ...
        public override void _Ready()
        {
            ...
            if (Instance != null)
            {
                var errorString = "[GoapPlannerManager] Trying to instantiate a new manager but there can be only one.";
