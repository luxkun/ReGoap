...
Also you can just download the last release's unity package, which probably won't have latest changes, [here, https://github.com/luxkun/ReGoap/releases/tag/0](https://github.com/luxkun/ReGoap/releases/tag/0).
